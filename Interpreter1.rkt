...
(define do-in-order-helper
  (lambda(l-o-e env)
    (cond
      ((eq? l-o-e '())'())
      ((create-var-exp? (car l-o-e)) (do-in-order-helper (cdr l-o-e) (apply-expression (car l-o-e) env)))
      (else (cons(apply-expression (car l-o-e) env)(do-in-order-helper (cdr l-o-e) env))))))
...
(run-program '(do-in-order (remember t (literal 3)) (display (get-value t))) env)
